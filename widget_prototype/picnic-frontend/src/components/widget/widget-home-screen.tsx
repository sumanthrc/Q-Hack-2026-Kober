  ...
  return (
    <div className="h-full flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Base gradient — deep navy to dark teal */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(180deg, #08080f 0%, #0c0a1c 15%, #12102a 30%, #0e1824 55%, #0a1f24 75%, #0b1a1e 100%)",
          }}
        />
        {/* Bloom orbs — purple top, teal bottom */}
        <motion.div
          animate={{ opacity: [0.35, 0.5, 0.35], scale: [1, 1.06, 1] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
          className="absolute w-[300px] h-[300px] rounded-full blur-[90px]"
          style={{
        ...
        />
        <motion.div
          animate={{ opacity: [0.25, 0.38, 0.25], scale: [1, 1.08, 1] }}
        ...
        <motion.div
          ...
          className="absolute w-[280px] h-[280px] rounded-full blur-[85px]"
          style={{
            background: "radial-gradient(circle, #0d4f5a 0%, transparent 70%)",
            bottom: "10%",
            left: "-5%",
          }}
        />
        <motion.div
          animate={{ opacity: [0.15, 0.25, 0.15], scale: [1, 1.07, 1] }}
