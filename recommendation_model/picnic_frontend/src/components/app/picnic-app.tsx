...
export function PicnicApp() {
  ...
  return (
    <div className="h-full flex flex-col bg-white pt-[54px]">
      ...
      {/* Bottom tab bar */}
      <div className="bg-white border-t border-gray-100 px-2 pb-4 pt-1">
              ...
              >
                <div className="relative">
                  <Icon
                    size={22}
                    className={
                      isActive ? "text-[#E1002A]" : "text-gray-400"
                    }
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute -top-1 left-1/2 -translate-x-1/2 w-8 h-0.5 rounded-full bg-[#E1002A]"
                  />
                )}
              </button>
            );
