...
export function CartWidget({
  ...
  if (!isLoggedIn) {
    return (
      <div
        className="w-full rounded-[22px] p-4 border border-white/[0.10]"
        style={glassStyle}
      >
  ...
  return (
    <div
      className="w-full rounded-[22px] border border-white/[0.10] select-none"
      style={glassStyle}
    >
      {/* Top highlight */}
      <div
      ...
      >
        ...
        {/* Row 3: Added by — visible when shared cart active + has adders, grayed out when off */}
        {adders.length > 0 && (
